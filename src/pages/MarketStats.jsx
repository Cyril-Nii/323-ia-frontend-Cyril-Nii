...
import { MARKET_STATS_METRICS, MARKET_STATS_ASSET_LISTS } from '../data/marketStatsData.js';
                ...
                <div className="w-full border-t border-gray-10">
                    {MARKET_STATS_METRICS.map((metric) => (
                        <MetricRow
                            ...
                            listTitle={metric.listTitle}
                            assets={MARKET_STATS_ASSET_LISTS[metric.assetList] || []}
                        />
                    ))}
                </div>
            </main>
