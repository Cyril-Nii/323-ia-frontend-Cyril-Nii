...
export default function SubscribePopup({ onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/60 p-4">
            <div className="relative w-full max-w-125 overflow-hidden rounded-3xl bg-white shadow-2xl flex flex-col">
                {/* Close Button */}
                <button
                    onClick={onClose}
                ...
                {/* Image Section - Top */}
                <div className="w-full h-62.5 bg-[#F7F8FA]">
                    <img
                ...
                <div className="w-full flex-1 p-8 text-center flex flex-col justify-center">
                    {subscribed ? (
                        <div className="flex flex-col items-center justify-center space-y-4 transition-opacity duration-500">
                            ...
                            <p className="text-gray-60 mt-2">Thanks for subscribing to Crypto Bytes.</p>
                            <button
                                onClick={onClose}
                        ...
                        <div className="flex flex-col items-center transition-opacity duration-500">
                            <h3 className="mb-2 text-3xl font-display font-medium text-black">
                                Keep learning with our platform
                            </h3>
                            <p className="mb-6 text-gray-60 text-lg">
                                Get updates on market prices and news, sent to your inbox.
                            </p>
                            ...
                            <p className="mt-6 text-xs text-gray-50 leading-relaxed">
                                By submitting your email address, you are signing up to receive updates from our platform. For information on how we use your data see our{' '}
                                <a href="#" className="text-blue-60 hover:underline">Privacy Policy</a>.
                            </p>
                        </div>
                    )}
                </div>
