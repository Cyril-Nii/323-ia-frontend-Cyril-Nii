...
const AssetRow = ({ asset }) => {
    ...
    return (
        <div className="flex flex-col w-full py-4 border-b border-white/8 transition-colors duration-150 hover:bg-white/4 rounded-lg cursor-pointer">
...
const CryptoTable = () => {
    ...
    return (
        <div className="flex flex-col w-full bg-gray-100 rounded-2xl p-6 min-h-134.5">
            {/* Tabs */}
